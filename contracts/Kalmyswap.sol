...
import "./interfaces/IUserSwapFee.sol";
...
contract KalmarTokenPriviledge is Partnership {
    ...
    function updateUserSwapFee(address _userSwapFeeAddr) public onlyOwner
    {
        // maximum fee have to <= 0.5%
        require(IUserSwapFee(_userSwapFeeAddr).maxFee() <= 500000);
